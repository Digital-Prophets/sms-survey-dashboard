...
then
    ...
    rsync -L  backups/latest.dmp staging.sms-survey-dashboard.digiprophets.com:/home/sms-survey-dashboard/deployment/backups/
    rsync -r -v media/ staging.sms-survey-dashboard.digiprophets.com:/home/sms-survey-dashboard/deployment/media
	...
	ssh staging.sms-survey-dashboard.digiprophets.com "cd /home/sms-survey-dashboard/deployment && git fetch --tags && git checkout $VERSION && make collectstatic && make reload"
else
